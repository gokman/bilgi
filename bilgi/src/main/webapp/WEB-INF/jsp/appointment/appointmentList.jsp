...
<body bgcolor="#AF4555">
	<table align="center" cellspacing="0" cellpadding="0" width="1000px" bgcolor="#FFFFFF">
									...
									<tr>
										...
										<table bgcolor="#ffffff"  width="100%" height="100%"
											...
											<tbody>
												...
												<c:forEach var="appointment" items="${activeAppointments}" varStatus="rowCounter">
		...
		<a href="<c:url value="/appointment/appointmentDetail/${appointment.id}.htm"/>">
		...
		<br/>											
								<span style="position: relative">
								    <a href="<c:url value="/appointment/appointmentDetail/${appointment.id}/${appointment.customerId}.htm"/>" class="liste_yazi">
										<font><c:out value="${appointment.id}" /></font>
									</a>
									  <br/>
									<a href="<c:url value="/appointment/appointmentDetail/${appointment.id}/${appointment.customerId}.htm"/>" class="liste_yazi">
									    <b>	
										<c:out value="${appointment.app_date}" />
										</b>
									    <b>	
										<c:out value="${appointment.app_time}" />
										</b>										
									</a>									
								</span>
		</td></tr></table>
