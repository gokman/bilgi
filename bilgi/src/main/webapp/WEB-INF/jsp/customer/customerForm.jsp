...
-->
				...
				<form:input  path="name" name="recordClientNameFirst" id="recordClientNameFirst" class="formtext" title="First Name is required" maxlength="50" />
				<form:errors  path="name"></form:errors>
				<br/>
				<label for="recordClientNameLast" class="input required">Last Name:</label>
				<form:input class="formtext"  path="surname" name="recordClientNameLast" id="recordClientNameLast" maxlength="50" title="Last Name is required" />
...
<li id="sf2">
	...
	<h3 class="stepHeader">Tell us about the property you're selling</h3>
       ...
       <br />
		...
		<form:input path="salary" name="recordClientSalary" id="recordClientSalary" class="formtext" title="Aylik Gelir" maxlength="20" />
		...
		<form:input path="occupation" name="recordClientOccupation" id="recordClientOccupation" class="formtext" title="Meslek" maxlength="100" />
		<form:errors path="occupation"></form:errors>
		<br />
		
		<label for="recordClientPlaceOfWork" class="input required">Calisilan Kurum:</label>
		<form:input path="placeOfWork" name="recordClientPlaceOfWork" id="recordClientPlaceOfWork" class="formtext" title="Calisilan Kurum" maxlength="150" />
...
<label for="recordClientState" class="input required">State:</label>
	...
	<form:input path="city" name="recordPropertyCity" id="recordPropertyCity" class="formtext" title="City is required" maxlength="100"  onblur="recordClientCity.value = this.value" /><br />
...
<form:input path="phoneNumber" name="recordClientPhone" id="recordClientPhone" class="formtext" maxlength="20" title="Phone Number is required"/>
