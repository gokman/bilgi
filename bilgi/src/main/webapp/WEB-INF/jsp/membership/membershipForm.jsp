	...
	<form:form  name="cmaForm" id="cmaForm" action="${saveMember}" method="POST" modelAttribute="user"  enctype="multipart/form-data" >
		...
		<ul id="stepForm" class="ui-accordion-container">
			...
			<div>
				...
				<fieldset>
				<legend> Step 1 of 3 - Kullanici Bilgileri</legend> 
				<div class="requiredNotice">*Required Field</div>
				<h3 class="stepHeader">Kullanici Kayit Formu</h3>
				<div class="formspacer" > </div>

				<label for="name" class="input required">Ad:</label>
				<form:input path="name" name="name" id="name" class="inputclass {required:true}" title="Ad" maxlength="254"  onblur="recordClientCity.value = this.value" /><br /> 
	   	        <br />
	   	       
				<label for="surname" class="input required">Soyad:</label>
				<form:input path="surname" name="surname" id="surname" class="inputclass {required:true}" title="Soyad" maxlength="50"  onblur="recordClientCity.value = this.value" /><br />
				<br />					
				
				<label for="username" class="input required">Kullanici Adi:</label>
				<form:input path="username" name="username" id="username" class="inputclass {required:true}" title="Kullanici adi" maxlength="50"  onblur="recordClientCity.value = this.value" /><br />
				<br />					
				
				<label for="password" class="input required">Sifre:</label>
				<form:input type="password" path="password" name="password" id="password" class="inputclass {required:true}" title="Sifre" maxlength="10"  onblur="recordClientCity.value = this.value" /><br />
				<br />					


				<label for="birthPlace" class="input required">Dogum Yeri:</label>
				<form:input path="birthPlace" name="birthPlace" id="birthPlace" class="inputclass {required:true}" maxlength="254" title="Dogum Yeri"/>
				<br />

				<label for="adress" class="input required">Adres:</label>
				<form:input path="adress" name="adress" id="adress" class="inputclass {required:true}" maxlength="254" title="Adres "/>
				<br />

				<label for="email" class="input required">E-mail:</label>
				<form:input type="email" path="email" name="email" id="email" class="inputclass {required:true}" maxlength="254" title="Email"/>
				<br />

				<label for="phoneNumber" class="input required">Telefon Numarasi:</label>
				<form:input path="phoneNumber" name="phoneNumber" id="phoneNumber" class="inputclass {required:true}" maxlength="254" title="Telefon Numarasi"/>
				<br />

				<label for="file" class="input required">Profil Resmi:</label>
				<input type="file" class="inputclass {required:true}" id="file" name="file" title="Kullanici Resmi" />
				<br />

				<!-- formdaki hatalar icin 
